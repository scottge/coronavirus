...
excerpt: "Live stats of COVID-19 in Italy. Total Cases: 218268 (+1083), Deaths: 30395 (+194), Recoveries: 103031(+4008)."
...
<div class="total-stats" style="text-align: center;">
    <h3>
	    ...
	    218268 (<span class='red'>+1083</span>)
    </h3>
    <h3>
	    <div style="font-size: 18px; font-weight: 400;">Total Deaths:</div>
	    30395 (<span class='red'>+194</span>)
    </h3>
    <h3>
	    <div style="font-size: 18px; font-weight: 400;">Total Recovered:</div>
	    103031 (<span class='green'>+4008</span>)
    </h3>
</div>
