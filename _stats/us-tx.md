...
excerpt: "Live stats of COVID-19 in US-Texas. Total Cases: 40201 (+311), Deaths: 1136 (+3), Recoveries: 23570(-)."
...
<div class="total-stats" style="text-align: center;">
    <h3>
	    ...
	    40201 (<span class='red'>+311</span>)
    </h3>
    <h3>
	    <div style="font-size: 18px; font-weight: 400;">Total Deaths:</div>
	    1136 (<span class='red'>+3</span>)
    </h3>
    <h3>
