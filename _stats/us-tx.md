...
excerpt: "Live stats of COVID-19 in US-Texas. Total Cases: 41149 (+294), Deaths: 1158 (+5), Recoveries: 24251(+659)."
...
<div class="total-stats" style="text-align: center;">
    <h3>
	    ...
	    41149 (<span class='red'>+294</span>)
    </h3>
    <h3>
	    <div style="font-size: 18px; font-weight: 400;">Total Deaths:</div>
	    1158 (<span class='red'>+5</span>)
    </h3>
    <h3>
