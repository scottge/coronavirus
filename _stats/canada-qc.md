...
excerpt: "Live stats of COVID-19 in Canada-Quebec. Total Cases: 36997 (+836), Deaths: 2787 (+61), Recoveries: 0(-)."
...
<div class="total-stats" style="text-align: center;">
    <h3>
	    ...
	    36997 (<span class='red'>+836</span>)
    </h3>
    <h3>
	    <div style="font-size: 18px; font-weight: 400;">Total Deaths:</div>
	    2787 (<span class='red'>+61</span>)
    </h3>
    <h3>
