...
excerpt: "Live stats of COVID-19 in US-Hawaii. Total Cases: 635 (+1), Deaths: 17 (-), Recoveries: 563(+2)."
...
<script type="text/javascript">
  ...
  function drawTable() {
    ...
    data.addRows([
      [{v:"Hawaii", f:"Hawaii"}, 75, 0, 75, 0, 0, 0],[{v:"Honolulu", f:"Honolulu"}, 410, 0, 399, 11, 0, 0],[{v:"Kauai", f:"Kauai"}, 21, 0, 21, 0, 0, 0],[{v:"Maui", f:"Maui"}, 117, 0, 111, 6, 0, 0],[{v:"Out of HI", f:"Out of HI"}, 11, 0, 11, 0, 0, 0],
    ]);
