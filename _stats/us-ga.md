...
excerpt: "Live stats of COVID-19 in US-Georgia. Total Cases: 34848 (+846), Deaths: 1494 (+50), Recoveries: 340(-)."
...
<div class="total-stats" style="text-align: center;">
    <h3>
	    ...
	    34848 (<span class='red'>+846</span>)
    </h3>
    <h3>
	    <div style="font-size: 18px; font-weight: 400;">Total Deaths:</div>
	    1494 (<span class='red'>+50</span>)
    </h3>
    <h3>
