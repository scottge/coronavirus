...
excerpt: "Live stats of COVID-19 in Canada-Ontario. Total Cases: 22154 (+337), Deaths: 1848 (+60), Recoveries: 0(-)."
...
<div class="total-stats" style="text-align: center;">
    <h3>
	    ...
	    22154 (<span class='red'>+337</span>)
    </h3>
    <h3>
	    <div style="font-size: 18px; font-weight: 400;">Total Deaths:</div>
	    1848 (<span class='red'>+60</span>)
    </h3>
    <h3>
