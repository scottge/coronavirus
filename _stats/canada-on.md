...
excerpt: "Live stats of COVID-19 in Canada-Ontario. Total Cases: 21847 (+30), Deaths: 1789 (+1), Recoveries: 0(-)."
...
<div class="total-stats" style="text-align: center;">
    <h3>
	    ...
	    21847 (<span class='red'>+30</span>)
    </h3>
    <h3>
	    <div style="font-size: 18px; font-weight: 400;">Total Deaths:</div>
	    1789 (<span class='red'>+1</span>)
    </h3>
    <h3>
