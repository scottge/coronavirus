...
excerpt: "Live stats of COVID-19 in US-Rhode Island. Total Cases: 10989 (+210), Deaths: 418 (+19), Recoveries: 730(-)."
...
<div class="total-stats" style="text-align: center;">
    <h3>
	    ...
	    10989 (<span class='red'>+210</span>)
    </h3>
    <h3>
	    <div style="font-size: 18px; font-weight: 400;">Total Deaths:</div>
	    418 (<span class='red'>+19</span>)
    </h3>
    <h3>
...
<script type="text/javascript">
  ...
  function drawRegionsMap() {
    var data = google.visualization.arrayToDataTable([
      ...
      [41.6988, -71.7339, "Kent", 703, 24],[41.4803, -71.3205, "Newport", 161, 1],[41.8882, -71.4774, "Providence", 7138, 200],[41.5151, -71.72, "Washington", 363, 20],[41.7257893, -71.3111773, "Bristol", 154, 0],
    ]);
    var options = {
...
<script type="text/javascript">
  ...
  function drawTable() {
    ...
    data.addRows([
      [{v:"Kent", f:"Kent"}, 703, 0, 679, 24, 0, 0],[{v:"Newport", f:"Newport"}, 161, 0, 160, 1, 0, 0],[{v:"Providence", f:"Providence"}, 7138, 0, 6938, 200, 0, 0],[{v:"Washington", f:"Washington"}, 363, 0, 343, 20, 0, 0],[{v:"Bristol", f:"Bristol"}, 154, 0, 154, 0, 0, 0],
    ]);
