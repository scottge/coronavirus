...
excerpt: "Live stats of COVID-19 in Canada. Total Cases: 72367 (+1103), Deaths: 5298 (+182), Recoveries: 8210(-)."
...
<div class="total-stats" style="text-align: center;">
    <h3>
	    ...
	    72367 (<span class='red'>+1103</span>)
    </h3>
    <h3>
	    <div style="font-size: 18px; font-weight: 400;">Total Deaths:</div>
	    5298 (<span class='red'>+182</span>)
    </h3>
    <h3>
