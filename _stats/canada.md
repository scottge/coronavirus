...
excerpt: "Live stats of COVID-19 in Canada. Total Cases: 68920 (+1244), Deaths: 4823 (+126), Recoveries: 8210(-)."
...
<div class="total-stats" style="text-align: center;">
    <h3>
	    ...
	    68920 (<span class='red'>+1244</span>)
    </h3>
    <h3>
	    <div style="font-size: 18px; font-weight: 400;">Total Deaths:</div>
	    4823 (<span class='red'>+126</span>)
    </h3>
    <h3>
...
<script type="text/javascript">
  ...
  function drawRegionsMap() {
    var data = google.visualization.arrayToDataTable([
      ...
      ["Alberta", 6157, 116],["British Columbia", 2330, 129],["Cruise Ship: Grand Princess", 13, 0],["Manitoba", 286, 7],["New Brunswick", 120, 0],["Newfoundland and Labrador", 261, 3],["Northwest Territories", 5, 0],["Nova Scotia", 1011, 47],["Ontario", 21148, 1726],["Prince Edward Island", 27, 0],["Quebec", 36997, 2787],["Saskatchewan", 553, 7],["Yukon", 11, 0],["Diamond Princess", 1, 1],
    ]);
    var options = {
...
<script type="text/javascript">
  ...
  function drawTable() {
    ...
    data.addRows([
      [{v:"Alberta", f:"<a href='https://smartable.ai/apps/coronavirus/stats/canada-ab/'>Alberta</a>"}, 6157, 59, 6041, 116, 1, 0],[{v:"British Columbia", f:"<a href='https://smartable.ai/apps/coronavirus/stats/canada-bc/'>British Columbia</a>"}, 2330, 15, 2201, 129, 2, 0],[{v:"Cruise Ship: Grand Princess", f:"Cruise Ship: Grand Princess"}, 13, 0, 13, 0, 0, 0],[{v:"Manitoba", f:"Manitoba"}, 286, 0, 279, 7, 0, 0],[{v:"New Brunswick", f:"New Brunswick"}, 120, 0, 120, 0, 0, 0],[{v:"Newfoundland and Labrador", f:"Newfoundland and Labrador"}, 261, 0, 258, 3, 0, 0],[{v:"Northwest Territories", f:"Northwest Territories"}, 5, 0, 5, 0, 0, 0],[{v:"Nova Scotia", f:"Nova Scotia"}, 1011, 3, 964, 47, 1, 0],[{v:"Ontario", f:"<a href='https://smartable.ai/apps/coronavirus/stats/canada-on/'>Ontario</a>"}, 21148, 322, 19422, 1726, 61, 0],[{v:"Prince Edward Island", f:"Prince Edward Island"}, 27, 0, 27, 0, 0, 0],[{v:"Quebec", f:"<a href='https://smartable.ai/apps/coronavirus/stats/canada-qc/'>Quebec</a>"}, 36997, 836, 34210, 2787, 61, 0],[{v:"Saskatchewan", f:"Saskatchewan"}, 553, 9, 546, 7, 0, 0],[{v:"Yukon", f:"Yukon"}, 11, 0, 11, 0, 0, 0],[{v:"Diamond Princess", f:"Diamond Princess"}, 1, 0, 0, 1, 0, 0],
    ]);
