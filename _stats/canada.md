...
excerpt: "Live stats of COVID-19 in Canada. Total Cases: 70895 (+804), Deaths: 5079 (+88), Recoveries: 8210(-)."
...
<div class="total-stats" style="text-align: center;">
    <h3>
	    ...
	    70895 (<span class='red'>+804</span>)
    </h3>
    <h3>
	    <div style="font-size: 18px; font-weight: 400;">Total Deaths:</div>
	    5079 (<span class='red'>+88</span>)
    </h3>
    <h3>
...
<script type="text/javascript">
  ...
  function drawRegionsMap() {
    var data = google.visualization.arrayToDataTable([
      ...
      ["Alberta", 6253, 117],["British Columbia", 2330, 129],["Cruise Ship: Grand Princess", 13, 0],["Manitoba", 287, 7],["New Brunswick", 120, 0],["Newfoundland and Labrador", 261, 3],["Northwest Territories", 5, 0],["Nova Scotia", 1019, 48],["Ontario", 21525, 1753],["Prince Edward Island", 27, 0],["Quebec", 38479, 3014],["Saskatchewan", 564, 7],["Yukon", 11, 0],["Diamond Princess", 1, 1],
    ]);
    var options = {
...
<script type="text/javascript">
  ...
  function drawTable() {
    ...
    data.addRows([
      [{v:"Alberta", f:"<a href='https://smartable.ai/apps/coronavirus/stats/canada-ab/'>Alberta</a>"}, 6253, 0, 6136, 117, 0, 0],[{v:"British Columbia", f:"<a href='https://smartable.ai/apps/coronavirus/stats/canada-bc/'>British Columbia</a>"}, 2330, 0, 2201, 129, 0, 0],[{v:"Cruise Ship: Grand Princess", f:"Cruise Ship: Grand Princess"}, 13, 0, 13, 0, 0, 0],[{v:"Manitoba", f:"Manitoba"}, 287, 0, 280, 7, 0, 0],[{v:"New Brunswick", f:"New Brunswick"}, 120, 0, 120, 0, 0, 0],[{v:"Newfoundland and Labrador", f:"Newfoundland and Labrador"}, 261, 0, 258, 3, 0, 0],[{v:"Northwest Territories", f:"Northwest Territories"}, 5, 0, 5, 0, 0, 0],[{v:"Nova Scotia", f:"Nova Scotia"}, 1019, 1, 971, 48, 1, 0],[{v:"Ontario", f:"<a href='https://smartable.ai/apps/coronavirus/stats/canada-on/'>Ontario</a>"}, 21525, 56, 19772, 1753, 2, 0],[{v:"Prince Edward Island", f:"Prince Edward Island"}, 27, 0, 27, 0, 0, 0],[{v:"Quebec", f:"<a href='https://smartable.ai/apps/coronavirus/stats/canada-qc/'>Quebec</a>"}, 38479, 747, 35465, 3014, 85, 0],[{v:"Saskatchewan", f:"Saskatchewan"}, 564, 0, 557, 7, 0, 0],[{v:"Yukon", f:"Yukon"}, 11, 0, 11, 0, 0, 0],[{v:"Diamond Princess", f:"Diamond Princess"}, 1, 0, 0, 1, 0, 0],
    ]);
