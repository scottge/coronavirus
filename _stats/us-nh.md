...
excerpt: "Live stats of COVID-19 in US-New Hampshire. Total Cases: 3011 (+64), Deaths: 131 (+10), Recoveries: 1228(+18)."
...
<div class="total-stats" style="text-align: center;">
    <h3>
	    ...
	    3011 (<span class='red'>+64</span>)
    </h3>
    <h3>
	    <div style="font-size: 18px; font-weight: 400;">Total Deaths:</div>
	    131 (<span class='red'>+10</span>)
    </h3>
    <h3>
	    <div style="font-size: 18px; font-weight: 400;">Total Recovered:</div>
	    1228 (<span class='green'>+18</span>)
    </h3>
</div>
...
<script type="text/javascript">
  ...
  function drawRegionsMap() {
    var data = google.visualization.arrayToDataTable([
      ...
      [43.443, -71.5937, "Belknap", 44, 0],[43.443, -71.5937, "Berknap", 2, 0],[44.0524, -71.1247, "Carroll", 36, 0],[42.9494, -72.2997, "Cheshire", 43, 2],[44.4869, -71.2599, "Coos", 2, 0],[43.9088, -71.826, "Grafton", 56, 1],[43.001, -71.5171, "Hillsborough", 1404, 52],[43.2232, -71.7129, "Merrimack", 234, 8],[42.9931, -71.0498, "Rockingham", 964, 47],[43.2534, -70.8856, "Strafford", 183, 11],[43.379, -72.3368, "Sullivan", 14, 1],
    ]);
    var options = {
...
<script type="text/javascript">
  ...
  function drawTable() {
    ...
    data.addRows([
      [{v:"Belknap", f:"Belknap"}, 44, 2, 44, 0, 0, 0],[{v:"Berknap", f:"Berknap"}, 2, 0, 2, 0, 0, 0],[{v:"Carroll", f:"Carroll"}, 36, 0, 36, 0, 0, 0],[{v:"Cheshire", f:"Cheshire"}, 43, 0, 41, 2, 0, 0],[{v:"Coos", f:"Coos"}, 2, 0, 2, 0, 0, 0],[{v:"Grafton", f:"Grafton"}, 56, 0, 55, 1, 0, 0],[{v:"Hillsborough", f:"Hillsborough"}, 1404, 29, 1352, 52, 3, 0],[{v:"Merrimack", f:"Merrimack"}, 234, 7, 226, 8, 1, 0],[{v:"Rockingham", f:"Rockingham"}, 964, 15, 917, 47, 3, 0],[{v:"Strafford", f:"Strafford"}, 183, 8, 172, 11, 0, 0],[{v:"Sullivan", f:"Sullivan"}, 14, 0, 13, 1, 0, 0],
    ]);
