...
excerpt: "Live stats of COVID-19 in US-Alabama. Total Cases: 10310 (+146), Deaths: 429 (+23), Recoveries: 20(-)."
...
<div class="total-stats" style="text-align: center;">
    <h3>
	    ...
	    10310 (<span class='red'>+146</span>)
    </h3>
    <h3>
	    <div style="font-size: 18px; font-weight: 400;">Total Deaths:</div>
	    429 (<span class='red'>+23</span>)
    </h3>
    <h3>
