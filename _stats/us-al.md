...
excerpt: "Live stats of COVID-19 in US-Alabama. Total Cases: 10464 (+300), Deaths: 435 (+29), Recoveries: 20(-)."
...
<div class="total-stats" style="text-align: center;">
    <h3>
	    ...
	    10464 (<span class='red'>+300</span>)
    </h3>
    <h3>
	    <div style="font-size: 18px; font-weight: 400;">Total Deaths:</div>
	    435 (<span class='red'>+29</span>)
    </h3>
    <h3>
