...
excerpt: "Live stats of COVID-19 in US-Missouri. Total Cases: 10135 (+127), Deaths: 504 (+7), Recoveries: 2063(-)."
...
<div class="total-stats" style="text-align: center;">
    <h3>
	    ...
	    10135 (<span class='red'>+127</span>)
    </h3>
    <h3>
	    <div style="font-size: 18px; font-weight: 400;">Total Deaths:</div>
	    504 (<span class='red'>+7</span>)
    </h3>
    <h3>
