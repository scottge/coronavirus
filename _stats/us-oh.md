...
excerpt: "Live stats of COVID-19 in US-Ohio. Total Cases: 24777 (+689), Deaths: 1357 (+10), Recoveries: 448(-)."
...
<div class="total-stats" style="text-align: center;">
    <h3>
	    ...
	    24777 (<span class='red'>+689</span>)
    </h3>
    <h3>
	    <div style="font-size: 18px; font-weight: 400;">Total Deaths:</div>
	    1357 (<span class='red'>+10</span>)
    </h3>
    <h3>
