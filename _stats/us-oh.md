...
excerpt: "Live stats of COVID-19 in US-Ohio. Total Cases: 25264 (+477), Deaths: 1438 (+76), Recoveries: 4168(+3720)."
...
<div class="total-stats" style="text-align: center;">
    <h3>
	    ...
	    25264 (<span class='red'>+477</span>)
    </h3>
    <h3>
	    <div style="font-size: 18px; font-weight: 400;">Total Deaths:</div>
	    1438 (<span class='red'>+76</span>)
    </h3>
    <h3>
	    <div style="font-size: 18px; font-weight: 400;">Total Recovered:</div>
	    4168 (<span class='green'>+3720</span>)
    </h3>
</div>
