...
excerpt: "Live stats of COVID-19 in Canada-Alberta. Total Cases: 6345 (+45), Deaths: 118 (+1), Recoveries: 0(-)."
...
<div class="total-stats" style="text-align: center;">
    <h3>
	    ...
	    6345 (<span class='red'>+45</span>)
    </h3>
    <h3>
	    <div style="font-size: 18px; font-weight: 400;">Total Deaths:</div>
	    118 (<span class='red'>+1</span>)
    </h3>
    <h3>
