...
excerpt: "Live stats of COVID-19 in US-Vermont. Total Cases: 921 (+2), Deaths: 54 (-), Recoveries: 744(+7)."
...
<script type="text/javascript">
  ...
  function drawRegionsMap() {
    var data = google.visualization.arrayToDataTable([
      ...
      [44.1664, -73.2555, "Addison", 62, 2],[43.0279, -73.135, "Bennington", 56, 1],[44.6431, -71.9791, "Caledonia", 14, 0],[44.4877, -73.2314, "Chittenden", 431, 37],[44.9083, -72.8029, "Franklin", 99, 5],[44.6366, -72.6786, "Lamoille", 26, 2],[44.1538, -72.0617, "Orange", 8, 0],[44.9509, -72.3043, "Orleans", 9, 0],[43.5181, -73.236, "Rutland", 50, 1],[44.1617, -72.4722, "Washington", 37, 1],[43.1219, -72.4555, "Windham", 74, 3],[43.33, -72.5262, "Windsor", 46, 2],[45.009, -71.4935, "Essex", 2, 0],[44.8595928, -73.2957299, "Grand Isle", 4, 0],
    ]);
    var options = {
...
<script type="text/javascript">
  ...
  function drawTable() {
    ...
    data.addRows([
      [{v:"Addison", f:"Addison"}, 62, 0, 60, 2, 0, 0],[{v:"Bennington", f:"Bennington"}, 56, 2, 55, 1, 0, 0],[{v:"Caledonia", f:"Caledonia"}, 14, 0, 14, 0, 0, 0],[{v:"Chittenden", f:"Chittenden"}, 431, 0, 394, 37, 0, 0],[{v:"Franklin", f:"Franklin"}, 99, 0, 94, 5, 0, 0],[{v:"Lamoille", f:"Lamoille"}, 26, 0, 24, 2, 0, 0],[{v:"Orange", f:"Orange"}, 8, 0, 8, 0, 0, 0],[{v:"Orleans", f:"Orleans"}, 9, 0, 9, 0, 0, 0],[{v:"Rutland", f:"Rutland"}, 50, 0, 49, 1, 0, 0],[{v:"Washington", f:"Washington"}, 37, 0, 36, 1, 0, 0],[{v:"Windham", f:"Windham"}, 74, 1, 71, 3, 0, 0],[{v:"Windsor", f:"Windsor"}, 46, 0, 44, 2, 0, 0],[{v:"Essex", f:"Essex"}, 2, 0, 2, 0, 0, 0],[{v:"Grand Isle", f:"Grand Isle"}, 4, 0, 4, 0, 0, 0],
    ]);
