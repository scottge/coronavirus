...
excerpt: "Live stats of COVID-19 in US-California. Total Cases: 70575 (+1189), Deaths: 2844 (+32), Recoveries: 11193(+65)."
...
<div class="total-stats" style="text-align: center;">
    <h3>
	    ...
	    70575 (<span class='red'>+1189</span>)
    </h3>
    <h3>
	    <div style="font-size: 18px; font-weight: 400;">Total Deaths:</div>
	    2844 (<span class='red'>+32</span>)
    </h3>
    <h3>
	    <div style="font-size: 18px; font-weight: 400;">Total Recovered:</div>
	    11193 (<span class='green'>+65</span>)
    </h3>
</div>
