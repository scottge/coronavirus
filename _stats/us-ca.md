...
excerpt: "Live stats of COVID-19 in US-California. Total Cases: 69386 (+1386), Deaths: 2812 (+69), Recoveries: 11128(+148)."
...
<div class="total-stats" style="text-align: center;">
    <h3>
	    ...
	    69386 (<span class='red'>+1386</span>)
    </h3>
    <h3>
	    <div style="font-size: 18px; font-weight: 400;">Total Deaths:</div>
	    2812 (<span class='red'>+69</span>)
    </h3>
    <h3>
...
<script type="text/javascript">
  ...
  function drawTable() {
    ...
    data.addRows([
      [{v:"Alameda", f:"Alameda"}, 2101, 37, 2026, 75, 3, 0],[{v:"Amador", f:"Amador"}, 16, 0, 13, 0, 0, 3],[{v:"Butte", f:"Butte"}, 20, 1, 20, 0, 0, 0],[{v:"Calaveras", f:"Calaveras"}, 13, 0, 11, 0, 0, 2],[{v:"Colusa", f:"Colusa"}, 3, 0, 3, 0, 0, 0],[{v:"Contra Costa", f:"Contra Costa"}, 1048, 0, 1016, 32, 0, 0],[{v:"El Dorado", f:"El Dorado"}, 56, 2, 40, 0, 0, 16],[{v:"Fresno", f:"Fresno"}, 945, 60, 851, 9, 0, 85],[{v:"Glenn", f:"Glenn"}, 6, 0, 4, 0, 0, 2],[{v:"Humboldt", f:"Humboldt"}, 61, 4, 11, 0, 0, 50],[{v:"Imperial", f:"Imperial"}, 564, 52, 491, 12, 0, 61],[{v:"Inyo", f:"Inyo"}, 20, 0, 19, 1, 0, 0],[{v:"Kern", f:"Kern"}, 1286, 32, 1036, 16, 0, 234],[{v:"Kings", f:"Kings"}, 319, 32, 318, 1, 0, 0],[{v:"Los Angeles", f:"Los Angeles"}, 32263, 560, 30461, 1570, 39, 232],[{v:"Madera", f:"Madera"}, 67, 0, 54, 2, 0, 11],[{v:"Marin", f:"Marin"}, 265, 4, 251, 14, 0, 0],[{v:"Mendocino", f:"Mendocino"}, 40, 0, 36, 0, 0, 4],[{v:"Merced", f:"Merced"}, 173, 10, 154, 3, 0, 16],[{v:"Mono", f:"Mono"}, 32, 3, 31, 1, 0, 0],[{v:"Monterey", f:"Monterey"}, 279, 0, 249, 6, 0, 24],[{v:"Napa", f:"Napa"}, 79, 0, 77, 2, 0, 0],[{v:"Nevada", f:"Nevada"}, 41, 0, 40, 1, 0, 0],[{v:"Orange", f:"Orange"}, 3557, 55, 3481, 76, 0, 0],[{v:"Placer", f:"Placer"}, 170, 1, 162, 8, 0, 0],[{v:"Riverside", f:"Riverside"}, 5189, 150, 4272, 217, 12, 700],[{v:"Sacramento", f:"Sacramento"}, 1173, 6, 1123, 50, 0, 0],[{v:"San Benito", f:"San Benito"}, 56, 1, 14, 2, 0, 40],[{v:"San Bernardino", f:"San Bernardino"}, 3015, 51, 2900, 115, 1, 0],[{v:"San Diego", f:"San Diego"}, 5065, 139, 3733, 194, 0, 1138],[{v:"San Francisco", f:"San Francisco"}, 1954, 11, 1919, 35, 1, 0],[{v:"San Joaquin", f:"San Joaquin"}, 621, 9, 592, 29, 0, 0],[{v:"San Luis Obispo", f:"San Luis Obispo"}, 226, 6, 114, 1, 0, 111],[{v:"San Mateo", f:"San Mateo"}, 1464, 39, 1399, 65, 8, 0],[{v:"Santa Barbara", f:"Santa Barbara"}, 1362, 54, 1182, 11, 0, 169],[{v:"Santa Clara", f:"Santa Clara"}, 2341, 2, 2211, 129, 0, 1],[{v:"Santa Cruz", f:"Santa Cruz"}, 141, 0, 91, 2, 0, 48],[{v:"Shasta", f:"Shasta"}, 32, 1, 22, 4, 0, 6],[{v:"Siskiyou", f:"Siskiyou"}, 5, 0, 2, 0, 0, 3],[{v:"Solano", f:"Solano"}, 379, 23, 226, 10, 3, 143],[{v:"Sonoma", f:"Sonoma"}, 309, 0, 196, 4, 0, 109],[{v:"Stanislaus", f:"Stanislaus"}, 508, 7, 393, 21, 0, 94],[{v:"Sutter", f:"Sutter"}, 45, 0, 10, 3, 0, 32],[{v:"Tulare", f:"Tulare"}, 1159, 19, 1054, 50, 2, 55],[{v:"Ventura", f:"Ventura"}, 679, 13, 438, 19, 0, 222],[{v:"Yolo", f:"Yolo"}, 174, 1, 154, 20, 0, 0],[{v:"Yuba", f:"Yuba"}, 21, 1, 20, 1, 0, 0],[{v:"Tuolumne", f:"Tuolumne"}, 4, 0, 4, 0, 0, 0],[{v:"Alpine", f:"Alpine"}, 8, 0, 7, 0, 0, 1],[{v:"Plumas", f:"Plumas"}, 4, 0, 4, 0, 0, 0],[{v:"Del Norte", f:"Del Norte"}, 3, 0, 1, 0, 0, 2],[{v:"Tehama", f:"Tehama"}, 1, 0, 0, 1, 0, 0],[{v:"Lake", f:"Lake"}, 8, 0, 8, 0, 0, 0],[{v:"Mariposa", f:"Mariposa"}, 15, 0, 15, 0, 0, 0],[{v:"Trinity", f:"Trinity"}, 1, 0, 1, 0, 0, 0],
    ]);
