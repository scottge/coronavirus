...
excerpt: "Live stats of COVID-19 in US-California. Total Cases: 70381 (+995), Deaths: 2825 (+13), Recoveries: 11146(+18)."
...
<div class="total-stats" style="text-align: center;">
    <h3>
	    ...
	    70381 (<span class='red'>+995</span>)
    </h3>
    <h3>
	    <div style="font-size: 18px; font-weight: 400;">Total Deaths:</div>
	    2825 (<span class='red'>+13</span>)
    </h3>
    <h3>
	    <div style="font-size: 18px; font-weight: 400;">Total Recovered:</div>
	    11146 (<span class='green'>+18</span>)
    </h3>
</div>
