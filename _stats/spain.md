...
excerpt: "Live stats of COVID-19 in Spain. Total Cases: 269520 (+1377), Deaths: 26920 (+176), Recoveries: 180470(+2624)."
...
<div class="total-stats" style="text-align: center;">
    <h3>
	    ...
	    269520 (<span class='red'>+1377</span>)
    </h3>
    <h3>
	    <div style="font-size: 18px; font-weight: 400;">Total Deaths:</div>
	    26920 (<span class='red'>+176</span>)
    </h3>
    <h3>
	    <div style="font-size: 18px; font-weight: 400;">Total Recovered:</div>
	    180470 (<span class='green'>+2624</span>)
    </h3>
</div>
