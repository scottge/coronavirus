...
excerpt: "Live stats of COVID-19 in US-Mississippi. Total Cases: 9686 (+165), Deaths: 438 (+7), Recoveries: 4421(-)."
...
<div class="total-stats" style="text-align: center;">
    <h3>
	    ...
	    9686 (<span class='red'>+165</span>)
    </h3>
    <h3>
	    <div style="font-size: 18px; font-weight: 400;">Total Deaths:</div>
	    438 (<span class='red'>+7</span>)
    </h3>
    <h3>
...
<script type="text/javascript">
  ...
  function drawTable() {
    ...
    data.addRows([
      [{v:"Adams", f:"Adams"}, 160, 1, 147, 13, 1, 0],[{v:"Alcorn", f:"Alcorn"}, 10, 0, 9, 1, 0, 0],[{v:"Amite", f:"Amite"}, 38, 0, 37, 1, 0, 0],[{v:"Attala", f:"Attala"}, 196, 5, 192, 4, 0, 0],[{v:"Benton", f:"Benton"}, 13, 0, 13, 0, 0, 0],[{v:"Bolivar", f:"Bolivar"}, 119, 0, 110, 9, 1, 0],[{v:"Calhoun", f:"Calhoun"}, 58, 0, 54, 4, 0, 0],[{v:"Carroll", f:"Carroll"}, 111, 0, 107, 4, 0, 0],[{v:"Chickasaw", f:"Chickasaw"}, 93, 1, 83, 10, 0, 0],[{v:"Choctaw", f:"Choctaw"}, 16, 0, 14, 2, 0, 0],[{v:"Claiborne", f:"Claiborne"}, 41, 0, 41, 0, 0, 0],[{v:"Clarke", f:"Clarke"}, 84, 3, 76, 8, 0, 0],[{v:"Clay", f:"Clay"}, 66, 0, 63, 3, 0, 0],[{v:"Coahoma", f:"Coahoma"}, 71, 0, 68, 3, 0, 0],[{v:"Copiah", f:"Copiah"}, 163, 1, 161, 2, 0, 0],[{v:"Covington", f:"Covington"}, 93, 3, 92, 1, 0, 0],[{v:"DeSoto", f:"DeSoto"}, 336, 3, 331, 5, 0, 0],[{v:"Forrest", f:"Forrest"}, 315, 1, 294, 21, 0, 0],[{v:"Franklin", f:"Franklin"}, 19, 0, 18, 1, 0, 0],[{v:"George", f:"George"}, 15, 0, 14, 1, 0, 0],[{v:"Grenada", f:"Grenada"}, 52, 1, 50, 2, 0, 0],[{v:"Hancock", f:"Hancock"}, 74, 0, 64, 10, 0, 0],[{v:"Harrison", f:"Harrison"}, 198, 0, 192, 6, 0, 0],[{v:"Hinds", f:"Hinds"}, 675, 5, 660, 15, 0, 0],[{v:"Holmes", f:"Holmes"}, 223, 10, 204, 19, 0, 0],[{v:"Humphreys", f:"Humphreys"}, 34, 4, 30, 4, 0, 0],[{v:"Itawamba", f:"Itawamba"}, 69, 1, 62, 7, 1, 0],[{v:"Jackson", f:"Jackson"}, 276, 1, 265, 11, 0, 0],[{v:"Jefferson", f:"Jefferson"}, 31, 1, 31, 0, 0, 0],[{v:"Jones", f:"Jones"}, 249, 2, 244, 5, 0, 0],[{v:"Kemper", f:"Kemper"}, 93, 1, 87, 6, 0, 0],[{v:"Lafayette", f:"Lafayette"}, 101, 3, 98, 3, 0, 0],[{v:"Lamar", f:"Lamar"}, 156, 4, 152, 4, 0, 0],[{v:"Lauderdale", f:"Lauderdale"}, 492, 10, 448, 44, 1, 0],[{v:"Lawrence", f:"Lawrence"}, 66, 0, 66, 0, 0, 0],[{v:"Leake", f:"Leake"}, 307, 8, 303, 4, 1, 0],[{v:"Lee", f:"Lee"}, 80, 2, 75, 5, 0, 0],[{v:"Leflore", f:"Leflore"}, 185, 0, 167, 18, 0, 0],[{v:"Lincoln", f:"Lincoln"}, 186, 0, 172, 14, 0, 0],[{v:"Lowndes", f:"Lowndes"}, 86, 3, 83, 3, 0, 0],[{v:"Madison", f:"Madison"}, 466, 35, 454, 12, 0, 0],[{v:"Marion", f:"Marion"}, 84, 1, 77, 7, 0, 0],[{v:"Marshall", f:"Marshall"}, 56, 1, 54, 2, 0, 0],[{v:"Monroe", f:"Monroe"}, 200, 0, 179, 21, 1, 0],[{v:"Montgomery", f:"Montgomery"}, 69, 0, 68, 1, 0, 0],[{v:"Neshoba", f:"Neshoba"}, 320, 5, 305, 15, 1, 0],[{v:"Newton", f:"Newton"}, 142, 4, 141, 1, 0, 0],[{v:"Noxubee", f:"Noxubee"}, 105, 3, 103, 2, 0, 0],[{v:"Oktibbeha", f:"Oktibbeha"}, 89, 0, 85, 4, 0, 0],[{v:"Panola", f:"Panola"}, 43, 0, 41, 2, 0, 0],[{v:"Pearl River", f:"Pearl River"}, 190, 0, 166, 24, 0, 0],[{v:"Perry", f:"Perry"}, 34, 0, 33, 1, 0, 0],[{v:"Pike", f:"Pike"}, 170, 2, 160, 10, 0, 0],[{v:"Pontotoc", f:"Pontotoc"}, 24, 0, 22, 2, 0, 0],[{v:"Prentiss", f:"Prentiss"}, 36, 0, 34, 2, 0, 0],[{v:"Quitman", f:"Quitman"}, 17, 0, 17, 0, 0, 0],[{v:"Rankin", f:"Rankin"}, 251, 1, 245, 6, 0, 0],[{v:"Scott", f:"Scott"}, 462, 5, 456, 6, 0, 0],[{v:"Sharkey", f:"Sharkey"}, 5, 0, 5, 0, 0, 0],[{v:"Simpson", f:"Simpson"}, 62, 1, 62, 0, 0, 0],[{v:"Smith", f:"Smith"}, 104, 4, 98, 6, 0, 0],[{v:"Sunflower", f:"Sunflower"}, 63, 0, 60, 3, 0, 0],[{v:"Tallahatchie", f:"Tallahatchie"}, 12, 0, 11, 1, 0, 0],[{v:"Tate", f:"Tate"}, 52, 2, 52, 0, 0, 0],[{v:"Tippah", f:"Tippah"}, 66, 1, 55, 11, 0, 0],[{v:"Tunica", f:"Tunica"}, 39, 0, 37, 2, 0, 0],[{v:"Union", f:"Union"}, 50, 2, 47, 3, 0, 0],[{v:"Walthall", f:"Walthall"}, 41, 2, 41, 0, 0, 0],[{v:"Warren", f:"Warren"}, 117, 0, 115, 2, 0, 0],[{v:"Washington", f:"Washington"}, 85, 3, 82, 3, 0, 0],[{v:"Webster", f:"Webster"}, 22, 0, 21, 1, 0, 0],[{v:"Wilkinson", f:"Wilkinson"}, 77, 0, 68, 9, 0, 0],[{v:"Winston", f:"Winston"}, 66, 3, 66, 0, 0, 0],[{v:"Yalobusha", f:"Yalobusha"}, 36, 5, 36, 0, 0, 0],[{v:"Yazoo", f:"Yazoo"}, 169, 5, 167, 2, 0, 0],[{v:"Tishomingo", f:"Tishomingo"}, 10, 0, 10, 0, 0, 0],[{v:"Jasper", f:"Jasper"}, 89, 3, 87, 2, 0, 0],[{v:"Wayne", f:"Wayne"}, 28, 1, 28, 0, 0, 0],[{v:"Stone", f:"Stone"}, 24, 0, 24, 0, 0, 0],[{v:"Greene", f:"Greene"}, 6, 0, 5, 1, 0, 0],[{v:"Jefferson Davis", f:"Jefferson Davis"}, 55, 2, 54, 1, 0, 0],
    ]);
